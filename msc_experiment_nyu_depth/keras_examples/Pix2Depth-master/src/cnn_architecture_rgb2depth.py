...
if __name__ == "__main__":
    # TODO: Remove Limite, but attention more than 1200 figures will freeze system!!!
    image_filenames = sorted(glob.glob('../../../nyu_depth/*/*_colors.png'))[:100]
    depth_filenames = sorted(glob.glob('../../../nyu_depth/*/*_depth.png'))[:100]

    print(len(image_filenames))
    print(len(depth_filenames))

    # train_images = sorted(glob.glob('nyu_depth/training/*_colors.png'))
    # train_depths = sorted(glob.glob('nyu_depth/training/*_depth.png'))
    # test_images = sorted(glob.glob('nyu_depth/testing/*_colors.png'))
    # test_depths = sorted(glob.glob('nyu_depth/testing/*_depth.png'))

    images = map(read_image, range(len(image_filenames)))
